...
<body>
    <div class="character-details-container">
                ...
                <ul>
                    <?php foreach ($available_transformations as $transformation): ?>
                        <li>
                            ...
                            <button type="submit" name="unlock_transformation" value="<?php echo $transformation['id']; ?>">Desbloquear</button>
                        </li>
                    <?php endforeach; ?>
                </ul>
            </form>
        ...
        <form action="listCharacters.php" method="get" style="display:inline;">
